...
<p align="center">
    <img border="0" src="https://archive.org/download/animated_1_copy/animated_1_copy.gif" width=300 height="300">
</p>
<p align="center">
...
<a href="https://discord.gg/R1T" style="font-size: 24px; color: rgb(255, 255, 255); text-decoration: none;">Discord.gg/R1T</a>
...
<body>
    <h1 class="animated-text">TEAM R1 Passed From Here</h1>
</body>
</html>
    <p id="ip-address">
    ...
    <div class="cmd-text-container" style="position: relative; top: -15px;">
        <div class="cmd-text" style="font-size: 17px; text-stroke: 3px black; color: black;"> You got hacked by R1 TEAM</div>
    </div>
...
<viedo style="width: 100vw; height: 100vh;" controls autoplay loop muted>
    <source src="https://cdn.discordapp.com/attachments/1075113172505210921/1230940739291316315/Untitled_video_-_Made_with_Clipchamp.mp4?ex=6644f7e6&is=6643a666&hm=516a2d852b15435ab90235b447a38dda0365315d7edfbf9a84c5d62ccf321088&">
